...
class AppColors {
  ...
  static const Color statusPaid = Color(0xFFE0F2F1);
  static const Color statusPaidText = Color(0xFF00695C);
  static const Color statusUnpaid = Color(0xFFFFF3E0);
  static const Color statusUnpaidText = Color(0xFFE65100);
}
