...
class AppColors {
  ...
  static const Color statusPaid = Color(0xFFF3E5F5);
  static const Color statusPaidText = Color(0xFF6A1B9A);
  static const Color statusUnpaid = Color(0xFFECEFF1);
  static const Color statusUnpaidText = Color(0xFF37474F);
}
